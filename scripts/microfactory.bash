...
function soong_build_go
{
    BUILDDIR=$(getoutdir) \
      ...
      EXTRA_ARGS="-pkg-path android/soong=${TOP}/build/soong -pkg-path derp/soong=${TOP}/vendor/derp/build/soong -pkg-path github.com/golang/protobuf=${TOP}/external/golang-protobuf" \
      build_go $@
}
